...
contains
  ...
  subroutine open_profile_dataset(Profiles, Domain, T_grid, &
    ...
    real, dimension(MAX_LINKS, MAX_LEVELS_FILE) :: flag_bfr
    ...
    do while ( cont )
       ...
       allocate(Prof%flag(num_levs));Prof%flag(:)=0.0
